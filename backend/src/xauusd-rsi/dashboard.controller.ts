  ...
  async getStatus() {
    ...
    return {
      ...
      thresholds: {
        ...
        extremeSellStated: SPEC.thresholds.extremeSellDisplayThreshold,
        extremeSellCrossingUsed: SPEC.thresholds.extremeSellCross,
        extremeBuy: SPEC.thresholds.extremeBuyCross,
        note: 'Buy 1 is 18, replacing the 14 shown in the screenshots. The extreme-SELL threshold is stated as 98.5 but the crossing and rearm rules are stated as 98; the crossing definition is what fires. See the frozen spec, §5.',
      },
