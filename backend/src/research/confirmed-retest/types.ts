/**
 * research/confirmed-retest/types — plain data shapes for
 * `xauusd-h4-confirmed-retest-v1`. Everything here is JSON-serializable
...
export interface Level {
  ...
  generation: number;
  firstPivotId: string;
  secondPivotId: string;
  alternativeFirstPivotIds: string[];
